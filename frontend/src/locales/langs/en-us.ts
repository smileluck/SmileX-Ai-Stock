const local: App.I18n.Schema = {
  ...
  route: {
    ...
    ai_factor: 'Factor Management',
    ai_backtest: 'Strategy Backtest',
    ...
    'ai_rotation-analysis': 'Rotation Strategy',
    about: 'About',
    demo: 'Example',
  ...
  page: {
    ...
    aiStrategy: {
      ...
      tabTemplates: 'Strategy Templates',
      templateTag: 'Template',
      templateTip: 'Published templates and preset strategies — clone to tweak and rerun; clones are disabled by default',
      clone: 'Clone',
      cloneThis: 'Clone Template',
      cloneConfirm: 'Cloning copies all settings into a disabled copy. Continue?',
      cloneSuccess: 'Cloned as a disabled copy — review and enable it under "Strategies"',
      export: 'Export',
      exportSuccess: 'Strategy JSON exported',
      publish: 'Publish',
      unpublish: 'Unpublish',
      publishTitle: 'Publish as Template - {name}',
      publishTags: 'Template Tags',
      publishTip: 'Published strategies appear under "Strategy Templates"; republish anytime to overwrite tags',
      publishSuccess: 'Published as template',
      unpublishSuccess: 'Unpublished',
      importStrategy: 'Import Strategy',
      importTitle: 'Import Strategy',
      importPlaceholder: 'Paste strategy JSON (schema_version=1)',
      importTip:
        'Get the strategy JSON via "Export" in the Strategies action column (schema_version=1); imported strategies are disabled by default and get a numeric suffix on name conflicts',
      importInputRequired: 'Please paste the strategy JSON',
      importInvalidJson: 'Failed to parse JSON, please check the content',
      importSuccess: 'Imported as a disabled strategy: {name}',
      tagsCol: 'Tags',
      cloneCountCol: 'Clones',
      lastBacktestCol: 'Latest Backtest',
      noBacktest: 'No backtest yet',
      btTrades: '{count} trades',
      ...
      compoundTip: 'Total return sums each trade\'s return; compound return accumulates them sequentially by sell time',
      equityCurve: 'Equity Curve',
      statsSelectStrategy: 'Select a strategy to view its equity curve and attribution',
      bySellReason: 'By Sell Reason',
      byRunPeriod: 'By Run Period',
      attrName: 'Group',
      attrCount: 'Trades',
      attrTotalReturn: 'Total Return',
      holdingCountCol: 'Holdings',
      periodReview: 'Review',
      periodUnknown: 'Legacy (Unknown)',
      openedCount: 'Opened',
      execTime: 'Time',
      execPeriod: 'Period',
      execStatus: 'Status',
      ...
      form: {
        ...
        stockPoolPlaceholderRule: 'Comma-separated 6-digit codes; required for rule strategy (no whole-market)',
        strategyType: 'Strategy Type',
        strategyTypeTip: 'Type cannot be changed after creation',
        buyConditions: 'Buy Conditions',
        buyConditionRequired: 'At least 1 complete buy condition is required',
        sellConditions: 'Sell Conditions',
        sellConditionsTip: 'Leave empty to exit only via stop-loss / take-profit / trailing drawdown',
        rulePoolRequired: 'Rule strategy requires a non-empty stock pool (no whole-market)',
    ...
    aiBacktest: {
      formTitle: 'Run Backtest',
      modeTip:
        'AI strategy backtest replays recorded real signals in range; rule strategy backtest evaluates factor conditions daily (no look-ahead)',
      tagAi: 'AI',
      tagRule: 'Rule',
      formStrategy: 'Strategy',
      formStrategyPlaceholder: 'Select a strategy to backtest',
      formRange: 'Date Range',
      formCapital: 'Initial Capital',
      advanced: 'Advanced Parameters',
      slippage: 'Slippage(%)',
      slippageModel: 'Slippage Model',
      slippageFixed: 'Fixed %',
      slippageAmp: 'Amplitude',
      slippageAmpLabel: 'Slippage Factor (%)',
      slippageAmpTip: 'Actual slippage = daily amplitude × factor / 100; 10 recommended',
      sweep: {
        entry: 'Sweep',
        title: 'Parameter Sweep (sync, results not persisted)',
        gridTip: "Risk-control grid: comma-separated candidates; empty = keep the strategy's current value",
        stopLoss: 'Stop(%)',
        takeProfit: 'Target(%)',
        trailing: 'Trail(%)',
        scanTip: 'Buy-condition threshold scan (rule strategies; filling values enables it)',
        scanCondition: 'Buy Condition',
        scanValues: 'Values',
        comboCount: '{n} combinations (limit 27)',
        comboOver: '{n} combinations exceed the limit of 27 — narrow the grid',
        comboEmpty: 'Provide at least one risk-control candidate list, or (rule) buy-condition values',
        submit: 'Run Sweep',
        resultTitle: 'Sweep Results ({n} runs, sorted by total return desc)',
        colParams: 'Params',
        best: 'Best',
        baseline: 'Current',
        apply: 'Apply',
        applyConfirm: "This overwrites the strategy's risk-control params (incl. buy-condition threshold for rule). Continue?",
        applySuccess: 'Params applied to strategy'
      },
      commission: 'Commission(%)',
      stampTax: 'Stamp Tax(%)',
      submit: 'Run Backtest',
      submitSuccess: 'Backtest submitted. Recorded AI signals are replayed against historical daily bars in the background. Check details when finished.',
      strategyRequired: 'Please select a strategy',
      rangeRequired: 'Please select the backtest date range',
      listTitle: 'Backtest Records',
      filterStrategy: 'Filter Strategy',
      strategyCol: 'Strategy',
      rangeCol: 'Range',
      statusCol: 'Status',
      ...
      lastRefresh: 'Last Refresh',
      detail: 'Detail',
      detailTitle: 'Backtest Detail - {name}',
      ...
      reason: 'Reason',
      reasonStopLoss: 'Stop Loss',
      reasonTarget: 'Target Reached',
      reasonTrailingStop: 'Trailing Stop',
      reasonAi: 'AI Signal',
      reasonBacktestEnd: 'Backtest End'
    },
    aiFactor: {
      tabLibrary: 'Factor Library',
      tabCalc: 'Factor Calculator',
      tabScreen: 'Stock Screener',
      libraryTitle: 'Factor List',
      create: 'New Factor',
      import: 'Import',
      ...
      deleteConfirm: 'Delete this factor?',
      presetTag: 'Preset',
      presetDeleteTip: 'Preset factors cannot be deleted; disable via the status switch',
      createTitle: 'New Factor',
      editTitle: 'Edit Factor',
      form: {
        name: 'Name',
        namePlaceholder: 'e.g. BIAS20',
        nameRequired: 'Please enter the factor name',
        code: 'Code',
        codePlaceholder: 'Globally unique, e.g. bias20',
        codeRequired: 'Please enter the factor code',
        codeImmutable: 'Code cannot be changed when editing',
        category: 'Category',
        formula: 'Formula',
        formulaTip:
          'Fields: open/high/low/close/volume/amount/preclose/pct_chg/vwap; functions: REF/MA/SUM/MAX/MIN/STD/DELTA/CORR/COUNT/ABS/LOG/SQRT/SIGN/IF/RANK',
        formulaRequired: 'Please enter the factor formula',
        description: 'Description',
        sourceUrl: 'Source URL',
        status: 'Status'
      },
      importModal: {
        title: 'Import Factors',
        byUrl: 'From URL',
        byContent: 'Paste JSON',
        formatTip:
          'Factor JSON format (array or single object):\n[{"name": "Factor name", "code": "unique-code", "category": "optional", "formula": "DSL formula", "description": "optional", "source_url": "optional"}]\nEach item is validated for formula and code uniqueness; conflicts are skipped and listed in the result.',
        inputRequired: 'Please enter a URL or JSON content',
        submit: 'Import',
      ...
      calc: {
        formTitle: 'Factor Calculator',
        factor: 'Factor',
        factorPlaceholder: 'Select a factor',
        codes: 'Stock Codes',
        codesPlaceholder: 'Separate codes with comma or space, e.g. 600519, 000001',
        fromStrategy: 'From Strategy',
        fromStrategyPlaceholder: 'Pick a strategy (use its pool)',
        poolEmpty: 'This strategy has an empty stock pool',
        date: 'Target Date',
        datePlaceholder: 'Latest trading day',
        lookback: 'Lookback Days',
        run: 'Calculate',
        factorRequired: 'Please select a factor',
        codesRequired: 'Please enter stock codes',
        resultTitle: 'Result (Trading Day)',
        stockCol: 'Stock',
        valueCol: 'Factor Value'
      },
      screen: {
        formTitle: 'Stock Screener',
        poolSource: 'Universe',
        poolManual: 'Manual Codes',
        poolStrategy: 'Strategy Pool',
        codesPlaceholder: 'Separate codes with comma or space, e.g. 600519, 000001',
        strategyPlaceholder: 'Pick a strategy (use its pool)',
        conditions: 'Conditions',
        conditionsTip: 'Conditions are combined with AND; "Top N" ranks by factor value descending',
        factorPlaceholder: 'Select a factor',
        opTopN: 'Top N',
        valuePlaceholder: 'Threshold',
        addCondition: 'Add Condition',
        run: 'Screen',
        conditionRequired: 'Please complete at least one condition (factor + value)',
        poolRequired: 'Please enter universe codes',
        strategyRequired: 'Please select a strategy',
        resultTitle: 'Screen Result',
        matchedCount: '{total} matched',
        stockCodeCol: 'Code',
        stockNameCol: 'Name',
        savePool: 'Save as Strategy Pool',
        savePoolTitle: 'Save to Strategy Pool',
        targetStrategy: 'Target Strategy',
        targetStrategyRequired: 'Please select a target strategy',
        savePoolTip: 'This overwrites the strategy stock pool; please confirm on the strategy page afterwards.',
        saveSuccess: 'Saved {total} stocks to the strategy pool; confirm on the strategy page'
      }
    },
    aiAnalysis: {
      ...
      rotation: {
        boardTitle: 'Rotation Metrics',
        historyDaysTip: '{n} trading days',
        syncStocksBtn: 'Sync Stocks',
        backfillBtn: 'Backfill History',
        syncSuccessTip: 'Stock snapshot synced: {boards} boards / {stocks} records',
        backfillTip: 'History backfill submitted (industry & concept, ~1-3 min each), metrics update automatically when done',
        tabOverview: 'Recent Rotation',
        tabTomorrow: 'Tomorrow Picks',
        tabSwitch: 'High-Low Switch',
        rankCol: 'Rank',
        boardCol: 'Board',
        changePctCol: 'Today %',
        gain3dCol: '3-Day',
        gain5dCol: '5-Day',
        gain10dCol: '10-Day',
        rankChangeCol: 'Rank Chg',
        volumeRatioCol: 'Vol Ratio',
        inflowDaysCol: 'Inflow Days',
        limitUpCol: 'Limit-Up',
        stageCol: 'Stage',
        scoreCol: 'Score',
        actionCol: 'Action',
        signalCol: 'Signal',
        highAvgCol: 'High-Group %',
        lowAvgCol: 'Low-Group %',
        positionKeyCol: 'Layer Key',
        codeCol: 'Code',
        nameCol: 'Name',
        priceCol: 'Price',
        amountCol: 'Turnover',
        positionGainCol: 'Position Gain',
        highLaggardsLabel: 'High-position laggards (worst today in high group)',
        lowStartersLabel: 'Low-position starters (best today in low group, ambush candidates)',
        expandEmpty: 'No stock snapshot for this board yet, sync stocks first',
        switchEmpty: 'No switch data yet, sync stock snapshots first',
        stage_start: 'Starting',
        stage_ferment: 'Fermenting',
        stage_climax: 'Climax',
        stage_ebb: 'Ebbing',
        stage_observe: 'Watching',
        action_attack: 'Attack',
        action_ambush: 'Ambush',
        action_avoid: 'Avoid',
        action_watch: 'Watch',
        signal_switching: 'Switching',
        signal_split: 'Split',
    ...
    financial: {
      ...
      forecastDriversLabel: 'Forecast Drivers',
      researchBriefLabel: 'Broker Forecast',
      strategyBtn: 'Strategy',
      strategyTitle: 'Interpretation Strategy',
      strategyTip: 'Custom requirements are appended to every AI interpretation (manual & scheduled). Leave empty to use the built-in default strategy',
      strategyPlaceholder:
        'Leave empty to use the built-in default strategy (rating / highlights / risks / forecast). Customize focus, style or risk preferences, e.g. focus on cash flow and dividends, downplay short-term growth',
