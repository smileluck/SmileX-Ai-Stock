const local: App.I18n.Schema = {
  ...
  page: {
    ...
    aiStrategy: {
      ...
      tabTemplates: '策略模板',
      templateTag: '模板',
      templateTip: '已发布的模板与系统预置策略，一键克隆后即可改参数重跑；克隆件默认停用',
      clone: '克隆',
      cloneThis: '克隆此模板',
      cloneConfirm: '克隆将复制全部配置并生成默认停用的副本，确认克隆？',
      cloneSuccess: '已克隆为停用副本，请到「策略管理」确认配置后手动启用',
      export: '导出',
      exportSuccess: '已导出策略 JSON',
      publish: '发布为模板',
      unpublish: '取消发布',
      publishTitle: '发布为模板 - {name}',
      publishTags: '模板标签',
      publishTip: '发布后出现在「策略模板」列表中，标签可随时通过重新发布覆盖更新',
      publishSuccess: '已发布为模板',
      unpublishSuccess: '已取消发布',
      importStrategy: '导入策略',
      importTitle: '导入策略',
      importPlaceholder: '粘贴策略 JSON（schema_version=1）',
      importTip: '策略 JSON 可从「策略管理」操作列「导出」获得（schema_version=1）；导入的新策略默认停用，名称冲突时自动追加序号',
      importInputRequired: '请粘贴策略 JSON',
      importInvalidJson: 'JSON 解析失败，请检查内容',
      importSuccess: '已导入为停用策略：{name}',
      tagsCol: '标签',
      cloneCountCol: '克隆次数',
      lastBacktestCol: '最近回测',
      noBacktest: '暂无回测',
      btTrades: '{count} 笔',
      createStrategy: '新建策略',
      editStrategy: '编辑策略',
      ...
      bestReturn: '最佳单笔',
      worstReturn: '最差单笔',
      compoundReturn: '复利收益率',
      compoundTip: '累计收益率=逐笔收益率简单求和；复利收益率=逐笔按卖出时间复利累积',
      equityCurve: '净值曲线',
      statsSelectStrategy: '请选择策略查看净值曲线与归因',
      bySellReason: '按卖出原因',
      byRunPeriod: '按执行时段',
      attrName: '分组',
      attrCount: '笔数',
      attrTotalReturn: '合计收益',
      holdingCountCol: '持仓数',
      periodReview: '复核',
      periodUnknown: '历史未知',
      openedCount: '新建仓',
      ...
      form: {
        ...
        stockPoolPlaceholderRule: '逗号分隔的6位代码，如 600519, 000001；规则策略必填（不支持全市场）',
        strategyType: '策略类型',
        strategyTypeTip: '类型创建后不可修改',
        buyConditions: '买入条件',
        buyConditionRequired: '规则策略至少需要 1 条完整买入条件',
        sellConditions: '卖出条件',
        sellConditionsTip: '留空则仅靠止损/止盈/回撤离场',
        rulePoolRequired: '规则策略必须配置股票池（不支持全市场选股）',
        periods: '执行时段',
    ...
    aiBacktest: {
      formTitle: '发起回测',
      modeTip: 'AI 策略回测 = 回放区间内的历史真实信号；规则策略回测 = 逐日因子评估自产信号（无未来函数）',
      tagAi: 'AI',
      tagRule: '规则',
      formStrategy: '策略',
      formStrategyPlaceholder: '请选择要回测的策略',
      formRange: '回测区间',
      formCapital: '初始资金',
      advanced: '高级参数',
      slippage: '滑点(%)',
      ...
      slippageFixed: '固定百分比',
      slippageAmp: '振幅比例',
      slippageAmpLabel: '滑点系数(%)',
      slippageAmpTip: '实际滑点=当日振幅×系数/100，建议 10',
      sweep: {
        entry: '参数寻优',
        title: '参数寻优（同步执行，结果不落库）',
        gridTip: '风控参数网格：逗号分隔候选值，留空 = 该参数不参与扫描（沿用策略当前值）',
        stopLoss: '止损(%)',
        takeProfit: '止盈(%)',
        trailing: '回撤(%)',
        scanTip: '买入条件阈值扫描（规则型可选，填候选值即启用）',
        scanCondition: '买入条件',
        scanValues: '候选值',
        comboCount: '组合数 {n}（上限 27）',
        comboOver: '组合数 {n} 超过上限 27，请缩小网格',
        comboEmpty: '请至少给一组风控候选值，或（规则型）填买入条件候选值',
        submit: '开始寻优',
        resultTitle: '寻优结果（共 {n} 组，按总收益降序）',
        colParams: '参数组合',
        best: '最优',
        baseline: '当前参数',
        apply: '应用该组参数',
        applyConfirm: '将把该组参数覆盖写入策略风控配置（规则型含买入条件阈值），确认应用？',
        applySuccess: '已应用该组参数到策略配置'
      },
      commission: '佣金(%)',
      stampTax: '印花税(%)',
      submit: '发起回测',
      submitSuccess: '已提交回测，后台回放真实 AI 信号按历史日线撮合，完成后可查看详情',
      strategyRequired: '请选择要回测的策略',
      ...
      lastRefresh: '最近刷新',
      detail: '详情',
      detailTitle: '回测详情 - {name}',
      deleteConfirm: '确定删除该回测记录吗？',
      equity: '净值',
      equityCurve: '收益曲线',
      warnings: '告警',
      tradesTitle: '成交明细',
    ...
    aiFactor: {
      ...
      categoryMomentum: '动量',
      categoryVolume: '量价',
      categoryVolatility: '波动',
      categoryImported: '导入',
      categoryCustom: '自定义',
      deleteConfirm: '确定删除该因子吗？',
      presetTag: '预置',
      presetDeleteTip: '预置因子不可删除，可通过状态开关停用',
      createTitle: '新建因子',
      editTitle: '编辑因子',
      form: {
        name: '名称',
        namePlaceholder: '如 BIAS20 乖离率',
        nameRequired: '请输入因子名称',
        code: '代码',
        codePlaceholder: '全局唯一，如 bias20',
        codeRequired: '请输入因子代码',
        codeImmutable: '编辑时代码不可修改',
        category: '分类',
        formula: '公式',
        formulaTip: '字段 open/high/low/close/volume/amount/preclose/pct_chg/vwap；函数 REF/MA/SUM/MAX/MIN/STD/DELTA/CORR/COUNT/ABS/LOG/SQRT/SIGN/IF/RANK',
        formulaRequired: '请输入因子公式',
        description: '描述',
        sourceUrl: '来源链接',
        status: '状态'
      },
      importModal: {
        ...
        byContent: '粘贴 JSON',
        formatTip:
          '因子 JSON 格式约定（数组或单个对象）：\n[{"name": "因子名称", "code": "唯一代码", "category": "分类(可选)", "formula": "DSL 公式", "description": "说明(可选)", "source_url": "来源链接(可选)"}]\n逐条校验公式合法性与 code 唯一性，冲突或非法条目将跳过并在结果中列出。',
        inputRequired: '请输入 URL 或 JSON 内容',
        submit: '导入',
        resultTitle: '导入结果',
        importedCount: '成功 {count} 条',
        skippedCount: '跳过 {count} 条'
      },
      calc: {
        formTitle: '因子试算',
        factor: '因子',
        factorPlaceholder: '请选择因子',
        codes: '股票代码',
        codesPlaceholder: '多个代码用逗号或空格分隔，如 600519, 000001',
        fromStrategy: '从策略带入',
        fromStrategyPlaceholder: '选择策略（用其股票池）',
        poolEmpty: '该策略股票池为空',
        date: '目标日期',
        datePlaceholder: '默认最新交易日',
        lookback: '回看天数',
        run: '开始计算',
        factorRequired: '请选择因子',
        codesRequired: '请输入股票代码',
        resultTitle: '计算结果（目标交易日）',
        stockCol: '股票',
        valueCol: '因子值'
      },
      screen: {
        ...
        poolStrategy: '策略股票池',
        codesPlaceholder: '多个代码用逗号或空格分隔，如 600519, 000001',
        strategyPlaceholder: '选择策略（用其股票池）',
        conditions: '选股条件',
        conditionsTip: '多条件为 AND 关系；「前N名」按该因子值降序取前 N',
        factorPlaceholder: '选择因子',
        opTopN: '前N名',
        valuePlaceholder: '阈值',
        addCondition: '添加条件',
        run: '开始选股',
        conditionRequired: '请至少完善一行条件（因子 + 数值）',
        poolRequired: '请输入股票池代码',
        strategyRequired: '请选择策略',
        resultTitle: '选股结果',
        matchedCount: '命中 {total} 只',
        stockCodeCol: '代码',
        stockNameCol: '名称',
        savePool: '存为策略股票池',
        savePoolTitle: '保存到策略股票池',
        targetStrategy: '目标策略',
        targetStrategyRequired: '请选择目标策略',
        savePoolTip: '将覆盖该策略现有股票池；保存后请前往策略页确认配置。',
        saveSuccess: '已保存 {total} 只股票到策略股票池，可前往策略页确认'
      }
    },
    aiAnalysis: {
      reportTitle: 'AI 分析报告',
      ...
      rotation: {
        boardTitle: '轮动指标监控',
        historyDaysTip: '近{n}个交易日',
        syncStocksBtn: '同步成分股',
        backfillBtn: '回填历史',
        syncSuccessTip: '成分股同步完成：{boards} 个板块 / {stocks} 条记录',
        backfillTip: '历史回填已提交后台执行，行业/概念各约1-3分钟，完成后自动参与计算',
        tabOverview: '近期轮动',
        tabTomorrow: '明日候选',
        tabSwitch: '高低切换',
        rankCol: '排名',
        ...
        priceCol: '最新价',
        amountCol: '成交额',
        positionGainCol: '位置涨幅',
        highLaggardsLabel: '高位滞涨股（高位组今日表现最差）',
        lowStartersLabel: '低位启动股（低位组今日表现最好，埋伏候选）',
        expandEmpty: '该板块暂无成分股快照，请先同步成分股',
        switchEmpty: '暂无高低切换数据，请先同步成分股快照',
        stage_start: '低位启动',
        stage_ferment: '发酵',
        stage_climax: '高潮',
        stage_ebb: '退潮',
    ...
    financial: {
      ...
      forecastLabel: '下期预测',
      forecastDriversLabel: '预测依据',
      researchBriefLabel: '券商预测对照',
      strategyBtn: '分析策略',
      strategyTitle: '财报解读分析策略',
      strategyTip: '定制要求会追加注入每次 AI 财报解读（手动与持仓定时），留空则使用内置默认策略',
      strategyPlaceholder: '留空使用内置默认策略（评级/亮点/风险/下期预测框架）。可定制关注面、分析风格、风控偏好等，如：重点关注现金流与分红能力，弱化短期增速',
      strategySaved: '分析策略已保存',
